    ...
    <div className="min-h-screen bg-white overflow-x-hidden relative">
      ...
      <section className="min-h-screen flex items-center px-6 md:px-16">
        <div className="grid md:grid-cols-2 gap-12 w-full max-w-7xl mx-auto items-center">
          ...
          <motion.div style={{ rotateX, rotateY }} className="relative h-[440px] perspective-distant mt-10">
            ...
            <motion.img src={Mascota} alt="Mascota Impulso" animate={{ y: [0, -12, 0], rotate: [-1, 1, -1] }} transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }} className="absolute -top-16 -right-10 w-28 md:w-36 object-contain drop-shadow-2xl pointer-events-none select-none z-20" style={{ filter: "drop-shadow(0 12px 24px rgba(242,100,25,0.25))" }} />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-16 bg-gradient-to-br from-[#FEF0E8] to-white">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <motion.img src={Mascota} alt="Mascota Impulso" animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 3.5, ease: "easeInOut" }} className="w-40 md:w-56 object-contain drop-shadow-2xl shrink-0 select-none" style={{ filter: "drop-shadow(0 12px 24px rgba(242,100,25,0.2))" }} />
