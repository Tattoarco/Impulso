    ...
    try {
      const res = await fetch("/api/ai/chat", {
        ...
        body: JSON.stringify({
          ...
          messages: [{ role: "user", content: "Hola, quiero crear un proyecto para Impulso." }],
        }),
      });
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-9 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="col-span-2 flex flex-col gap-1.5">
                ...
                <input
                  className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-xl bg-gray-50 text-sm text-gray-900 outline-none transition-all
                    focus:border-[#F26419] focus:bg-white focus:shadow-[0_0_0_3px_rgba(242,100,25,0.1)]
                    ${infoErrors.title ? "border-red-500" : "border-gray-200"}`}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-xl bg-gray-50 text-sm text-gray-900 outline-none cursor-pointer transition-all appearance-none
                    focus:border-[#F26419] focus:bg-white focus:shadow-[0_0_0_3px_rgba(242,100,25,0.1)]
                    ${infoErrors.area ? "border-red-500" : "border-gray-200"}`}
                  value={info.area}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold text-gray-700">
                  Duración estimada <span className="text-[#F26419]">*</span>
                </label>
                <select
                  className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-xl bg-gray-50 text-sm text-gray-900 outline-none cursor-pointer transition-all appearance-none
                    focus:border-[#F26419] focus:bg-white focus:shadow-[0_0_0_3px_rgba(242,100,25,0.1)]
                    ${infoErrors.duration ? "border-red-500" : "border-gray-200"}`}
                  value={info.duration}
              ...
              <div className="col-span-2 flex flex-col gap-1.5">
                ...
                <textarea
                  className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-xl bg-gray-50 text-sm text-gray-900 outline-none resize-y min-h-22.5 leading-relaxed transition-all
                    focus:border-[#F26419] focus:bg-white focus:shadow-[0_0_0_3px_rgba(242,100,25,0.1)]
                    ${infoErrors.description ? "border-red-500" : "border-gray-200"}`}
                  placeholder="En 2-3 líneas, ¿de qué trata el proyecto? La IA completará el resto..."
            ...
            <div className="bg-white rounded-2xl border border-gray-200 flex flex-col h-150 shadow-sm overflow-hidden">
              ...
              <div className="px-5 py-4 border-t border-gray-200 flex gap-2.5">
                <input
                  ...
                  placeholder={chatDone ? "Chat completado" : "Escribe tu respuesta..."}
                  value={userInput}
